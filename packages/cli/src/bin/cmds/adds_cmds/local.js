...
module.exports = {
  ...
  handler: function (args) {
    return __awaiter(this, void 0, void 0, function () {
      var _a, configStore, saveConfigStore, local, resource;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4 /*yield*/, local.insert(configStore, args.fileEnv)];
          case 1:
            resource = _b.sent();
            console.log(
              chalk_1.default(
            ...
            configStore.defaultSelect(
              EnvConfigStore_1.TypeEnvConfig.local,
              resource.name
            );
            return [2 /*return*/];
        }
