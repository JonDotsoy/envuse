  ...
  handler: function (args) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            defaultHerokuApp = args.app || args["heroku-app"];
          ...
          case 1:
            (_b = _c.sent().herokuApp),
              (herokuApp = _b === void 0 ? defaultHerokuApp : _b);
            ow_1.default(
              herokuApp,
              "heroku app name",
              ow_1.default.string.nonEmpty
            );
            return [4 /*yield*/, heroku.insert(configStore, herokuApp)];
          case 2:
            resource = _c.sent();
            console.log(
              chalk_1.default(
            ...
            saveConfigStore();
            configStore.defaultSelect(
              EnvConfigStore_1.TypeEnvConfig.heroku,
              resource.name
            );
            return [2 /*return*/];
        }
